import 'package:decodart/ui/core/scaffold/navigation_bar/classic_navigation_bar.dart' show ClassicNavigationBar;
import 'package:decodart/ui/core/miscellaneous/button/apropos_button.dart' show AproposButton;
import 'package:decodart/ui/core/scaffold/scaffold/classic_scaffold.dart' show ClassicScaffold;
import 'package:decodart/ui/core/scaffold/scaffold/searchable_or_large_title_scaffold.dart' show SearchableOrLargeTitleScaffold;
...
class _DecodPageScaffoldState extends State<DecodPageScaffold> {
  ...
  // Flutter now supports directly navigation bar with search bar..
  // however, the animation is less finalized than our custom code
  @override
