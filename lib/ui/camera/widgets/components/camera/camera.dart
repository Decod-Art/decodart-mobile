import 'package:decodart/data/api/artwork.dart' show fetchArtworkByImage;
...
import 'package:decodart/ui/camera/widgets/components/camera/button.dart' show CameraButtonWidget;
import 'package:decodart/ui/camera/view_model/view_model.dart' show CameraViewModel;
import 'package:decodart/ui/camera/widgets/components/camera/core_camera.dart' show CoreCamera;
import 'package:decodart/ui/camera/widgets/components/results/no_result.dart' show NoResultWidget;
import 'package:decodart/ui/camera/widgets/components/results/result.dart' show ResultWidget;
import 'package:decodart/ui/camera/widgets/components/results/results.dart' show ResultsView;
...
class _CameraState extends State<Camera> with SingleTickerProviderStateMixin{
  late final CameraViewModel controller;
