...
import 'package:decodart/data/api/decod.dart' show fetchDecodQuestions;
...
import 'package:decodart/data/model/decod.dart' show DecodQuestion, DecodQuestionType, DecodTag;
import 'package:decodart/data/model/hive/decod.dart' show GameData;
import 'package:decodart/util/logger.dart';



class GameViewModel extends MenuViewModel {
  double _total = 0;
  double points = 0;
  ...
  GameViewModel({this.artwork, this.tag});
