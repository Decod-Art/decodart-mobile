...
import 'package:decodart/ui/decod/widgets/menu/util/stats/_empty.dart' show EmptyStat;
import 'package:decodart/ui/decod/widgets/menu/util/stats/_stat_content.dart' show StatContent;
...
class StatsWidgetState extends State<StatsWidget> {
  final MenuViewModel controller = MenuViewModel();
